...
| ~~[#99](https://github.com/ZhannaM85/mouse-fixes/issues/99)~~ | ~~feat: support `--auto-merge` with the `resume` command~~ | ~~Flag is silently dropped by resume arg parsing; extends #47~~ |
